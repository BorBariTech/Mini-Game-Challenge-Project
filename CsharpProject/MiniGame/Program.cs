...
A Mini-game application with the following features:
...
This is a C# Console application developed using VS Code
...
void Move(int speed = 1, bool exitOtherKeys = false)
{
    int lastX = playerX;
    int lastY = playerY;
